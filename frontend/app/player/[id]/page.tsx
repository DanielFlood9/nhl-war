...
const PLAYERS = [
  ...
  { id:6,  name:"Pavel Dorofeyev",   team:"VGK", pos:"L", gp:13, g:10, a:8,  pts:18, toi:198, war:1.72, gar:10.32, ev_off:4.22, ev_def:1.52, pp:2.88, pen:0.44, fin:2.06, clutch:0.16, gax:1.88, pct_war:80, pct_evo:76, pct_evd:60, pct_pp:80, pct_fin:96, pct_play:60, pct_trans:84, pct_pen:68, score:86, tier:"Elite Goal Scorer", tier_color:"#3b82f6", insight:["Goals leader · 10G in 13 playoff games","96th pct finishing · elite conversion rate","Dangerous PP weapon","Below-average defensive RAPM"], scout:"Dorofeyev's goal-scoring has been the most prolific of the playoffs and his finishing RAPM confirms it's skill not luck — converting at a rate well above expected." },
  { id:7,  name:"Brett Howden",      team:"VGK", pos:"C", gp:13, g:10, a:8,  pts:18, toi:192, war:1.64, gar:9.84,  ev_off:3.88, ev_def:1.78, pp:2.62, pen:0.68, fin:1.48, clutch:0.16, gax:1.42, pct_war:76, pct_evo:68, pct_evd:68, pct_pp:76, pct_fin:84, pct_play:56, pct_trans:76, pct_pen:80, score:82, tier:"Strong Top-Six", tier_color:"#3b82f6", insight:["10 goals in 13 games · elite finisher","Positive penalty differential","Reliable PP contributor","Strong two-way presence"], scout:"Howden has been a reliable two-way presence for Vegas. His finishing metrics show genuine skill and his penalty differential is among the best on the team." },
